...
public class HDD_All {
    ...
    public HDD_All(int id, String productID, String productName, double size, String storage, String type, int hddRPM, int hddCache, String diskType, String company, String usage, int warranty, String status){
        this.id = id;
        this.productID = productID;
        this.productName = productName;
        this.size = size;
