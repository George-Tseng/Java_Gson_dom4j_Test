...
public class Java_Gson_Dom4j_Test {
	public static void main(String[] args){
		/*開關*/
	    boolean mode1 = false, mode2 = false, mode3 = false, mode4 = false;
        ...
        banner = (File_Conf.checkResultJSON()) ? banner + System.lineSeparator() + "輸入「3」可讀取位於工作目錄的json檔案，並產生cvs檔與xml檔" : banner;
        /*如果ResultXML存在，才能執行讀取XML檔案的功能*/
        banner = (File_Conf.checkResultXML()) ? banner + System.lineSeparator() + "輸入「4」可讀取位於工作目錄的xml檔案" : banner;
        ...
        while(true) {
            ...
            if(mode1){
                ...
                hddFullList.add(new HDD_All(40001, "WD10EFRX", "紅標 Plus", 3.5, "1 TB", "傳統硬碟", 5400, 64, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40002, "ST1000VN002", "那嘶狼", 3.5, "1 TB", "傳統硬碟", 5900, 64, "CMR", "Seagate", "NAS", 3, "可購得"));

                hddFullList.add(new HDD_All(40101, "WD20EFAX", "紅標", 3.5, "2 TB", "傳統硬碟", 5400, 256, "SMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40102, "WD20EFRX", "紅標 Plus", 3.5, "2 TB", "傳統硬碟", 5400, 64, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40103, "ST2000VN004", "那嘶狼", 3.5, "2 TB", "傳統硬碟", 5900, 64, "CMR", "Seagate", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40104, "WD20FFSX", "旗艦紅標", 3.5, "2 TB", "傳統硬碟", 7200, 64, "CMR", "WD", "NAS", 5, "可購得"));
                hddFullList.add(new HDD_All(40105, "ST2000NE0025", "那嘶狼 Pro", 3.5, "2 TB", "傳統硬碟", 7200, 128, "CMR", "Seagate", "NAS", 5, "可購得"));

                hddFullList.add(new HDD_All(40201, "WD30EFAX", "紅標", 3.5, "3 TB", "傳統硬碟", 5400, 256, "SMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40202, "WD30EFRX", "紅標 Plus", 3.5, "3 TB", "傳統硬碟", 5400, 64, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40203, "ST3000VN007", "那嘶狼", 3.5, "3 TB", "傳統硬碟", 5900, 64, "CMR", "Seagate", "NAS", 3, "可購得"));

                hddFullList.add(new HDD_All(40301, "WD40EFAX", "紅標", 3.5, "4 TB", "傳統硬碟", 5400, 256, "SMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40302, "WD40EFRX", "紅標 Plus", 3.5, "4 TB", "傳統硬碟", 5400, 64, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40303, "ST4000VN008", "那嘶狼", 3.5, "4 TB", "傳統硬碟", 5900, 64, "CMR", "Seagate", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40304, "HDWQ140AZSTA", "N300", 3.5, "4 TB", "傳統硬碟", 7200, 128, "CMR", "Toshiba", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40305, "WD4003FFBX", "旗艦紅標", 3.5, "4 TB", "傳統硬碟", 7200, 256, "CMR", "WD", "NAS", 5, "可購得"));
                hddFullList.add(new HDD_All(40306, "ST4000NE001", "那嘶狼 Pro", 3.5, "4 TB", "傳統硬碟", 7200, 128, "CMR", "Seagate", "NAS", 5, "可購得"));

                hddFullList.add(new HDD_All(40401, "WD60EFAX", "紅標", 3.5, "6 TB", "傳統硬碟", 5400, 256, "SMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40402, "WD60EFRX", "紅標 Plus", 3.5, "6 TB", "傳統硬碟", 5400, 64, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40403, "ST6000VN001", "那嘶狼", 3.5, "6 TB", "傳統硬碟", 5400, 256, "CMR", "Seagate", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40404, "HDWN160AZSTA", "N300", 3.5, "6 TB", "傳統硬碟", 7200, 128, "CMR", "Toshiba", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40405, "WD6003FFBX", "旗艦紅標", 3.5, "6 TB", "傳統硬碟", 7200, 256, "CMR", "WD", "NAS", 5, "可購得"));
                hddFullList.add(new HDD_All(40406, "ST6000NE000", "那嘶狼 Pro", 3.5, "6 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 5, "可購得"));

                hddFullList.add(new HDD_All(40501, "WD80EFAX", "紅標 Plus", 3.5, "8 TB", "傳統硬碟", 5400, 256, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40502, "ST8000VN004", "那嘶狼", 3.5, "8 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40503, "HDWN180AZSTA", "N300", 3.5, "8 TB", "傳統硬碟", 7200, 128, "CMR", "Toshiba", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40504, "WD8003FFBX", "旗艦紅標", 3.5, "8 TB", "傳統硬碟", 7200, 256, "CMR", "WD", "NAS", 5, "可購得"));
                hddFullList.add(new HDD_All(40505, "ST8000NE001", "那嘶狼 Pro", 3.5, "8 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 5, "可購得"));

                hddFullList.add(new HDD_All(40601, "WD101EFAX", "紅標 Plus", 3.5, "10 TB", "傳統硬碟", 5400, 256, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40602, "ST10000VN0008", "那嘶狼", 3.5, "10 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40603, "HDWG11AAZSTA", "N300", 3.5, "10 TB", "傳統硬碟", 7200, 256, "CMR", "Toshiba", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40604, "WD102KFBX", "旗艦紅標", 3.5, "10 TB", "傳統硬碟", 7200, 256, "CMR", "WD", "NAS", 5, "可購得"));
                hddFullList.add(new HDD_All(40605, "ST10000NE0008", "那嘶狼 Pro", 3.5, "10 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 5, "可購得"));

                hddFullList.add(new HDD_All(40701, "WD120EFAX", "紅標 Plus", 3.5, "12 TB", "傳統硬碟", 5400, 256, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40702, "ST12000VN0008", "那嘶狼", 3.5, "12 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40703, "HDWG21CAZSTA", "N300", 3.5, "12 TB", "傳統硬碟", 7200, 256, "CMR", "Toshiba", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40704, "WD121KFBX", "旗艦紅標", 3.5, "12 TB", "傳統硬碟", 7200, 256, "CMR", "WD", "NAS", 5, "可購得"));
                hddFullList.add(new HDD_All(40705, "ST12000NE0008", "那嘶狼 Pro", 3.5, "12 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 5, "可購得"));

                hddFullList.add(new HDD_All(40801, "WD140EFFX", "紅標 Plus", 3.5, "14 TB", "傳統硬碟", 5400, 512, "CMR", "WD", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40802, "ST14000VN0008", "那嘶狼", 3.5, "14 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40803, "MN07ACA14T", "N300", 3.5, "14 TB", "傳統硬碟", 7200, 256, "CMR", "Toshiba", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40804, "WD141KFBX", "旗艦紅標", 3.5, "14 TB", "傳統硬碟", 7200, 512, "CMR", "WD", "NAS", 5, "可購得"));
                hddFullList.add(new HDD_All(40805, "ST14000NE0008", "那嘶狼 Pro", 3.5, "14 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 5, "可購得"));

                hddFullList.add(new HDD_All(40901, "ST16000VN001", "那嘶狼", 3.5, "16 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 3, "可購得"));
                hddFullList.add(new HDD_All(40902, "ST16000NE000", "那嘶狼 Pro", 3.5, "16 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 5, "可購得"));

                hddFullList.add(new HDD_All(41001, "ST18000NE000", "那嘶狼 Pro", 3.5, "18 TB", "傳統硬碟", 7200, 256, "CMR", "Seagate", "NAS", 5, "可購得"));
                ...
                hddFullList.add(new HDD_All(60001, "WD10JFCX", "紅標", 2.5, "1 TB", "傳統硬碟", 5400, 16, "CMR", "WD", "NAS", 3, "可購得"));
